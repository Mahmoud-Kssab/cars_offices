    ...
    <div class="wrapper">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-right">
                      <a href="{{route('changepassword.index')}}"class="btn btn-default btn-flat"> تغيير كلمة المرور</a>
                    </div>
                    <div class="pull-left">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <li class="treeview sidebar-form" > <a href=""> <h3 style="color: #4b8dba; text-align: center"> <img src="{{ URL::asset('adminlte/images/shoghl.png') }}" class="user-image" alt="User Image" width="25" height="25"> الصفحة الرئيسية </h3> </a> </li>
